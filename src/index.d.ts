...
export interface FullTheme {
  Avatar: RecursivePartial<AvatarProps>;
  Badge: RecursivePartial<BadgeProps>;
  Button: RecursivePartial<ButtonProps>;
  ButtonGroup: RecursivePartial<ButtonGroupProps>;
  Card: RecursivePartial<CardProps>;
  CheckBox: RecursivePartial<CheckBoxProps>;
  Divider: RecursivePartial<DividerProps>;
  Header: RecursivePartial<HeaderProps>;
  Icon: RecursivePartial<IconProps>;
  Image: RecursivePartial<ImageProps>;
  Input: RecursivePartial<InputProps>;
  ListItem: RecursivePartial<ListItemProps>;
  Overlay: RecursivePartial<OverlayProps>;
  PricingCard: RecursivePartial<PricingCardProps>;
  Rating: RecursivePartial<RatingProps>;
  AirbnbRating: RecursivePartial<AirbnbRatingProps>;
  SearchBar: RecursivePartial<SearchBarProps>;
  Slider: RecursivePartial<SliderProps>;
  SocialIcon: RecursivePartial<SocialIconProps>;
  Text: RecursivePartial<TextProps>;
  Tile: RecursivePartial<TileProps>;
  Tooltip: RecursivePartial<TooltipProps>;
